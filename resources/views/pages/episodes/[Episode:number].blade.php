...
<x-layout>
    @volt
        <div x-data class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow">
            <div class="p-6">
            ...
            <div class="bg-gray-50 px-6 py-4">
                <a href="/episodes" wire:navigate class="text-sm font-medium text-gray-600">
